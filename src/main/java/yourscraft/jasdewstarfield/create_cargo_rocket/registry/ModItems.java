...
import yourscraft.jasdewstarfield.create_cargo_rocket.content.station.DockingStationBlockItem;
...
public class ModItems {
    ...
    public static final DeferredItem<Item> DOCKING_STATION = ITEMS.register("docking_station",
            () -> new DockingStationBlockItem(ModBlocks.DOCKING_STATION.get(), new Item.Properties()));
